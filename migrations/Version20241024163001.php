 ...
 */
final class Version20241024163001 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE sub_account (id INT AUTO_INCREMENT NOT NULL, account_id INT NOT NULL, current_balance_id INT DEFAULT NULL, iban VARCHAR(255) NOT NULL, bic VARCHAR(255) NOT NULL, account_number VARCHAR(255) NOT NULL, blz VARCHAR(255) NOT NULL, is_enabled TINYINT(1) NOT NULL, description VARCHAR(255) DEFAULT NULL, INDEX IDX_2EE0A509B6B5FBA (account_id), UNIQUE INDEX UNIQ_2EE0A50712A6AAF (current_balance_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE sub_account ADD CONSTRAINT FK_2EE0A50712A6AAF FOREIGN KEY (current_balance_id) REFERENCES current_balance (id)');
