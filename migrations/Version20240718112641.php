 ...
 */
final class Version20240718112641 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE category (id INT AUTO_INCREMENT NOT NULL, category_group_id INT NOT NULL, name VARCHAR(255) NOT NULL, tree_ignore TINYINT(1) DEFAULT NULL, dashboard_ignore TINYINT(1) DEFAULT NULL, INDEX IDX_64C19C1492E5D3C (category_group_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE split_transaction (id INT AUTO_INCREMENT NOT NULL, transaction_id INT NOT NULL, category_id INT NOT NULL, amount INT NOT NULL, description VARCHAR(255) NOT NULL, valuta_date DATE NOT NULL, INDEX IDX_29F52C6F2FC0CB0F (transaction_id), INDEX IDX_29F52C6F12469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
